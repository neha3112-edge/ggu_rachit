...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-RPWRVL59XM"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-RPWRVL59XM');
</script>
...
})(window,document,'script','dataLayer','GTM-MQ65RCTR');</script>
    ...
    <div class="container">
        <nav class="nav">
            ...
            <div class="nav-header">
                    ...
                    <a href="https://ggu.distanceeducationschool.in/">  
                        <img src="assets/img/golden-gate-logo-header.webp" class="logo" alt="Logo">
                    </a>
